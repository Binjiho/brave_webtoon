package com.example.brave_webtoon.security.config;

import com.example.brave_webtoon.security.filter.CustomAuthenticationFilter;
import com.example.brave_webtoon.security.filter.JwtAuthorizationFilter;
import com.example.brave_webtoon.security.handler.CustomAuthFailureHandler;
import com.example.brave_webtoon.security.handler.CustomAuthSuccessHandler;
import com.example.brave_webtoon.security.handler.CustomAuthenticationProvider;
...
public class SecurityConfig {
    ...
    public CustomAuthenticationFilter customAuthenticationFilter() {
        ...
        customAuthenticationFilter.setFilterProcessesUrl("/api/account/signIn");     // 접근 URL
